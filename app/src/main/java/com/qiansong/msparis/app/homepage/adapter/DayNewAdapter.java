...
public class DayNewAdapter extends
        RecyclerView.Adapter<DayNewAdapter.ViewHolder> {
    private LayoutInflater mInflater;
    private List<HomePageBean.DataBean.NewArrivalsBean> mDatas;
    Context context;
    public DayNewAdapter(Context context, List<HomePageBean.DataBean.NewArrivalsBean> datats) {
