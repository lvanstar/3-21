...
public class DisplayUtil {
    ...
    public static int getStickermWidth(Context context) {
        if (context == null) {
            return -1;
        }
        if (stickWidth == 0) {
            stickWidth = (int) ((getDisplayWidthPixels(context)) / 4);
        }
        return stickWidth;
    }
    /**
    ...
    public static int getChannelItemWidth(Context context) {
        ...
        return (int) ((getDisplayWidthPixels(context) - 2 * context.getResources().getDimension(R.dimen.horizontal_spacing)) / 2.93);
    }
    ...
    public static int getThumbNailItemWidth(Context context) {
        ...
        if(thumbnailWidth ==0) thumbnailWidth = ((int) ((getDisplayWidthPixels(context) - 2 * context.getResources().getDimension(R.dimen.horizontal_normal_spacing))-4*context.getResources().getDimension(R.dimen.horizontal_spacing)))/5;
        return thumbnailWidth;
    }

    public static int getThumbNailItemWidthSec(Context context) {
        if (context == null) {
            return -1;
        }
        if(thumbnailWidth ==0) thumbnailWidth = ((int) ((getDisplayWidthPixels(context) - 2 * context.getResources().getDimension(R.dimen.horizontal_normal_spacing))-3*context.getResources().getDimension(R.dimen.horizontal_spacing)-context.getResources().getDimension(R.dimen.horizontal_spacing_sec)))/5;
        return thumbnailWidth;
    }
    ...
    public static float getBannerItemHeight(Context context) {
        ...
        return ((getDisplayWidthPixels(context) - context.getResources().getDimension(R.dimen.horizontal_spacing)) * 350 / 510);
    }
    ...
    public static int getChannelRecommendItemWidth(Context context) {
        ...
        if (RecommendChannelPicWidth == 0) {
            RecommendChannelPicWidth = (int) ((getDisplayWidthPixels(context) - 2 * (context.getResources().getDimension(R.dimen.activity_horizontal_margin) + context.getResources().getDimension(R.dimen.horizontal_normal_spacing)) - 3 * context.getResources().getDimension(R.dimen.horizontal_spacing)) / 4);
        }
    ...
    public static int getUserItemHeight(Context context) {
        ...
        if (RecommendUserPicWidth == 0) {
            RecommendUserPicWidth = (int) (((getDisplayWidthPixels(context) - 2 * (context.getResources().getDimension(R.dimen.activity_horizontal_margin) + context.getResources().getDimension(R.dimen.horizontal_normal_spacing))) * 18 / 23 - 3 * context.getResources().getDimension(R.dimen.horizontal_spacing)) / 4);
        }
    ...
    public static int getBrowserChannelPicWidth(Context context) {
        ...
        if (PhotoWidth == 0) {
            PhotoWidth = RecommendChannelPicWidth = (int) ((getDisplayWidthPixels(context) - 2 * (context.getResources().getDimension(R.dimen.activity_horizontal_margin) + context.getResources().getDimension(R.dimen.horizontal_normal_spacing)) - 3 * context.getResources().getDimension(R.dimen.horizontal_spacing)) / 3);
        }
        return PhotoWidth;
    }
