 ...
 *                                                    --------叶晨
 */
public class PullToRefreshLunView extends LinearLayout{
    ...
    public PullToRefreshLunView(Context context) {
        super(context);
        init();
    }

    public PullToRefreshLunView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
