...
public class MemberItemAdapter extends BaseAdapter {
    ...
    public List<MineBean.DataBean.MemberPrivilegeBean> list = null;
     ...
     * @param list
     */
    public void setData(List<MineBean.DataBean.MemberPrivilegeBean> list) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        MemberItemAdapter.ViewHolder viewHolder = null;

        if (convertView == null) {
            convertView = View.inflate(context, R.layout.item_member, null);
            viewHolder = new MemberItemAdapter.ViewHolder(convertView);
            convertView.setTag(viewHolder);

        } else {
            viewHolder = (MemberItemAdapter.ViewHolder) convertView.getTag();
        }
